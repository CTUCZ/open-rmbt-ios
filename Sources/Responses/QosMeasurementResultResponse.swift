...
///
@objc final public class QosMeasurementResultResponse: BasicResponse {
    ...
    public func calculateQosSuccessPercentage() -> Float {
        var successCount = 0
    ...
    public func calculateQosSuccessPercentage() -> String? {
        if let testResultDetail = self.testResultDetail, testResultDetail.count > 0 {
    ...
    public func calculateQosSuccess() -> Int {
        var successCount = 0
    ...
    public func calculateQosFailed() -> Int {
