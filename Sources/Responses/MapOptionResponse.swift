...
///
@objc public final class MapOptionResponse: BasicResponse {
    ...
    var mapTypesOld: [MapTypeOld] = []
    var mapFiltersOld: [String: Any] = [:]
...
//    final class MapFilterOld: Mappable {
//        var title: String?
//        var options: [[String: Any]] = []
//
//        init?(map: Map) { }
...
//    }
    ...
    public class MapOverlays: MapOptionResponse.DefaultMappable, Equatable {
